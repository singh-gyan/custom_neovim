local key_maps = {
  ...
  { key = '<Space>Q', func = vim.lsp.buf.format, mode = 'n', desc = 'format' },
  { key = '<Space>Q', func = vim.lsp.buf.range_formatting, mode = 'v', desc = 'range format' },
  {
    key = '<Space>gm',
...
require("navigator").setup({
	...
	lsp = {
		disable_lsp = { "tssever" },
		format_on_save = { enable = { "lua", "go" }, disable = { "javascript", "typescript", "scss", "css" } },
		tsserver = {
